...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4double shape1_x = 20*cm,shape1_y = 10*cm,shape1_z = 0.1*mm;
 ...
 // auto solidShape2 = new G4Trd("Shape2",  // its name
   ...
   //
   //
   G4double shape2_x = 20*cm,shape2_y = 10*cm,shape2_z = 0.1*cm;
  auto solidShape2 = new G4Box("Shape2",                           // its name
      0.5 * shape2_x, 0.5 * shape2_y, 0.5 * shape2_z);  // its size
